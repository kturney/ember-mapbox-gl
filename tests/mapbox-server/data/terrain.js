export default JSON.stringify({
  ...
  "maxzoom": 16,
  "minzoom": 0,
  "name": "Mapbox Streets V7 + Vector Terrain V2",
  "scheme": "xyz",
  "tilejson": "2.2.0",
  "tiles": ["https://a.tiles.mapbox.com/v4/mapbox.mapbox-terrain-v2,mapbox.mapbox-streets-v7/{z}/{x}/{y}.vector.pbf?access_token=pk.eyJ1Ijoia3R1cm5leSIsImEiOiJjajFudmQ2Z2owMDBiMnlyd3FtZDl2dDlkIn0.5uUKBumz-7IWM_2PQ6cXQw&style=mapbox://styles/mapbox/streets-v9@0", "https://b.tiles.mapbox.com/v4/mapbox.mapbox-terrain-v2,mapbox.mapbox-streets-v7/{z}/{x}/{y}.vector.pbf?access_token=pk.eyJ1Ijoia3R1cm5leSIsImEiOiJjajFudmQ2Z2owMDBiMnlyd3FtZDl2dDlkIn0.5uUKBumz-7IWM_2PQ6cXQw&style=mapbox://styles/mapbox/streets-v9@0"],
  "vector_layers": [{
