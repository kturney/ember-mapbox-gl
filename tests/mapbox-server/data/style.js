export default JSON.stringify({
  ...
  "sources": {
    "composite": {
      "url": "mapbox://mapbox.mapbox-terrain-v2,mapbox.mapbox-streets-v7?style=mapbox://styles/mapbox/streets-v9@0",
      "type": "vector"
    }
  },
  ...
  "layers": [{
    ...
    "minzoom": 16,
    "filter": ["all", ["==", "$type", "LineString"],
      ["all", ["in", "class", "link", "path", "pedestrian", "service", "track"],
        ["==", "oneway", "true"],
        ["==", "structure", "tunnel"],
        ["!=", "type", "trunk_link"]
      ]
    ...
    "minzoom": 15,
    "filter": ["all", ["==", "$type", "LineString"],
      ["all", ["in", "class", "primary", "secondary", "street", "street_limited", "tertiary"],
        ["==", "oneway", "true"],
        ["==", "structure", "tunnel"],
        ["!=", "type", "trunk_link"]
      ]
    ...
    "minzoom": 16,
    "filter": ["all", ["==", "$type", "LineString"],
      ["all", ["in", "class", "link", "motorway", "motorway_link", "trunk"],
        ["==", "oneway", "true"],
        ["==", "structure", "tunnel"],
    ...
    "minzoom": 17,
    "filter": ["all", [">=", "localrank", 15],
      ["!in", "maki", "campsite", "cemetery", "dog-park", "garden", "golf", "park", "picnic-site", "playground", "zoo"],
      ["==", "scalerank", 4]
    ],
    "layout": {
    ...
    "source-layer": "poi_label",
    "minzoom": 15,
    "filter": ["all", ["in", "maki", "campsite", "cemetery", "dog-park", "garden", "golf", "park", "picnic-site", "playground", "zoo"],
      ["==", "scalerank", 4]
    ],
    "layout": {
      "text-line-height": 1.1,
    ...
    "minzoom": 15,
    "filter": ["all", ["==", "$type", "LineString"],
      ["!in", "class", "link", "motorway", "pedestrian", "primary", "secondary", "street", "street_limited", "tertiary", "trunk"]
    ],
    "layout": {
      "text-size": {
        "base": 1,
    ...
    "minzoom": 16,
    "maxzoom": 18,
    "filter": ["all", ["in", "$type", "LineString", "Point", "Polygon"],
      ["all", ["<=", "localrank", 10],
        ["==", "type", "residential"]
      ]
    ],
